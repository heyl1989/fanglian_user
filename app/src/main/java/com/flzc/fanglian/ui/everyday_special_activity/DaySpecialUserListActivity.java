...
public class DaySpecialUserListActivity extends BaseActivity implements OnClickListener,OnLoaderListener{
	...
	private void initView() {
		...
		userAdapter = new DaySpecialUserListAdapter(DaySpecialUserListActivity.this,uesrList);
	...
	private void initPartUserData(int page) {
		...
		SimpleRequest<DaySpecialPartUserListBean> req = new SimpleRequest<DaySpecialPartUserListBean>(
				API.QUERY_DAY_SPECIAL_PARTICIPANT, DaySpecialPartUserListBean.class, new Listener<DaySpecialPartUserListBean>() {
					@Override
