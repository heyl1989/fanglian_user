...
package com.flzc.fanglian.view.wheelview;
...
public class WheelView extends View {
	 ...
	 * �����ѡ���ڶ����͵ײ���������ֵ�� </br>
	 * ��ô������~ ��ʵ��һ�¾�֪���ˣ� </br>
	 * &nbsp; ����˵��picker����ʾ������(�м��Ǹ���ѡ�е�)��ʣ��4��ûѡ�еġ� </br>
	 * &nbsp; ��ûѡ�е���4���У�λ�ڶ����͵ײ����������Ӱ�ڵ�(�ڵ�һ���֣������û�����������Ҫ����������) </br>
	 * &nbsp; �����趨��ֵ������ָ���ڵ���size�������Ĭ��ֵ TEXT_SIZE / 5 ���ڵ���1/5���ֺ� (��ô��λҲӦ����sp��)
	 */
	...
	private void initData(Context context) {
		TEXT_SIZE = CommonUtils.dp2px(context, 14);
		ITEM_OFFSET = TEXT_SIZE / 7;
