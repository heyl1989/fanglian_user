...
/**
 * 
 * @ClassName: LoadListView 
 * @Description: 上拉加载更多的ListView
 * @author: LU
 * @date: 2016-3-30 上午10:24:30
 */
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		if (totalItemCount == lastVisibaleItem && scrollState == SCROLL_STATE_IDLE) {
			if (!isLoading) {
				...
				footer.findViewById(R.id.pb_progress).setVisibility(View.VISIBLE);
				TextView text = (TextView)footer.findViewById(R.id.tv_text);
				text.setText("加载中");
...
//		footer.findViewById(R.id.pb_progress).setVisibility(View.GONE);
//		TextView text = (TextView)footer.findViewById(R.id.tv_text);
//		text.setText("上拉加载更多");
