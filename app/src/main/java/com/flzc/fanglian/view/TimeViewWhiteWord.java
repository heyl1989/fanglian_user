...
public class TimeViewWhiteWord extends RelativeLayout implements Runnable {
	...
	public TimeViewWhiteWord(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	public TimeViewWhiteWord(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public TimeViewWhiteWord(Context context) {
		super(context);
		initView(context);
	}

	private void initView(Context context) {
		View.inflate(context, R.layout.time_layout_white_word, TimeViewWhiteWord.this);
