...
//		float exactContentHeight = FloatMath.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale());
		float	exactContentHeight = Float.valueOf(mRefreshableView.getContentHeight() * mRefreshableView.getScale());
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(0, Float.valueOf(mRefreshableView.getContentHeight() * mRefreshableView.getScale())
